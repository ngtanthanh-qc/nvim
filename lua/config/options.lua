...
-- -----------------------------------------------------------------------------
--  ABOUT  : Configure core Neovim behaviors such as line numbers,
--           indentation, scrolling, search, and UI defaults.
--
--  LOAD   : Automatically loaded during Neovim startup
--  FILE   : lua/config/options.lua
--  AUTHOR : Thanh Nguyen
--  NOTE   : Keep this file free of plugin-specific settings
-- =============================================================================
...
vim.opt.spelllang = { "en", "vi" } -- Set language for spellchecking
